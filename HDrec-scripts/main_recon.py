...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 19 18:16:29 2020
...
# Load sinograms
sinoName = args.xtest
print('Loading sinograms %s'%(sinoName))
hf_1 = h5py.File('./result_%s/proj/H5_File/%s.h5'%(args.tomo,sinoName),'r')
...
slice_num = [55,200,500,805,1000,1100,1315, 1400]#, 1479] 
